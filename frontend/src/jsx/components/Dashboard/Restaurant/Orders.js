                            ...
                            <div className="card-body">
                                ...
                                <div className="order-menu style-1 mt-3">
                                    ...
                                    <div className="d-flex align-items-center mb-4">
                                        ...
                                        <div>
                                            <h4 className="font-w600 text-nowrap mb-0"><Link to={"#"}>Pepperoni Pizza</Link></h4>
                                            <p className="mb-0">x1</p>
                                        </div>
                                        <h4 className="text-primary mb-0 ms-auto">+$5.59</h4>
                                    </div>
                                    <div className="d-flex align-items-center mb-4">
                                        <img className="me-3" src={review2} alt="" />
                                        <div>
                                            <h4 className="font-w600 text-nowrap mb-0"><Link to={"#"}>Japanese Ramen</Link></h4>
                                            <p className="mb-0">x1</p>
                                        </div>
                                        <h4 className="text-primary mb-0 ms-auto">+$5.59</h4>
                                    </div>
                                    <div className="d-flex align-items-center pb-2">
                                        <img className="me-3" src={pop1} alt="" />
                                        <div>
                                            <h4 className="font-w600 text-nowrap mb-0"><Link to={"#"}>Pepperoni Pizza</Link></h4>
                                            <p className="mb-0">x1</p>
                                        </div>
                                ...
                                <div className="d-flex align-items-center justify-content-between">
                                    ...
                                    <h4 className="cate-title text-primary">$16.77</h4>
                                </div>
                            </div>
                        </div>
                        <div className="text-end">
                            <Link to={"#"} className="btn btn-outline-danger me-sm-4 me-2">Reject Order</Link>
