...
const CierreCaja = () => {
	...
	const imprimir = () => {
		...
		const html = `<!doctype html><html lang="es"><head><meta charset="utf-8"><title>Cierre ${r.fecha}</title>
		...
		<>
			<div className="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
				...
				<div className="d-flex align-items-center gap-2">
					...
					<button className="btn btn-primary" onClick={imprimir} disabled={!data}>
